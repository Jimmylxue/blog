...
frp 这个是一个开源的目前已经拥有 100k star 的 github 开源的一个工具，首先我们可以正常的去 github 上下载对应机器类型的版本：
...
有时候我们直接在云服务器面板上看 明明添加了 8889 端口，但是访问 8889 端口就是调用不通，这时候我们可以使用命令行再次操作一次
